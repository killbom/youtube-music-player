...
exports.init = function (app) {
  ...
  trayMenu.append(new MenuItem({
    label: 'Play/Pause',
    click: app.controlPlayPause
  }));
  trayMenu.append(new MenuItem({
    label: 'Next',
    click: app.controlNext
  }));
  trayMenu.append(new MenuItem({
    label: 'Previous',
    click: app.controlPrevious
  }));
  trayMenu.append(new MenuItem({
    type: 'separator'
  }));
  ...
  ipcMain.on('change:playback', function handlePlaybackChange (evt, playbackState) {
    ...
    app.logger.debug('Playback state has changed. Updating tray icon', {
