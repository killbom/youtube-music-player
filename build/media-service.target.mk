...
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=media-service' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
$(builddir)/media-service.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/media-service.node: LIBS := $(LIBS)
$(builddir)/media-service.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/media-service.node: TOOLSET := $(TOOLSET)
$(builddir)/media-service.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/media-service.node
# Add target alias
.PHONY: media-service
media-service: $(builddir)/media-service.node

# Short alias for building this executable.
.PHONY: media-service.node
media-service.node: $(builddir)/media-service.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/media-service.node
